...
<project_name>Satang - AI 기반 지식 노트북 & 비주얼 콘텐츠 생성 플랫폼</project_name>
...
<overview>
Satang은 Google NotebookLM을 모델로 한 AI 기반 지식 관리 및 비주얼 콘텐츠 생성 플랫폼입니다. 사용자가 다양한 소스(PDF, 웹페이지, YouTube, Google Docs, 텍스트, 이미지, 오디오)를 업로드하면, AI가 이를 분석하여 요약, Q&A 채팅, 인포그래픽, 슬라이드, 마인드맵, 보고서 등 다양한 형태의 콘텐츠를 자동 생성합니다.
...
<pages_and_interfaces>
  <global_layout>
    ...
    <top_navigation_home>
      ...
      - 좌측: 로고 아이콘 (28px) + "Satang" 텍스트 (font-size: 18px, font-weight: 700, color: #1F2937)
    ...
    <top_navigation_notebook>
      - 높이: 48px
      - 배경: #FFFFFF, 하단 보더: 1px solid #E5E7EB
      - 좌측: Satang 로고 아이콘 (클릭 시 홈으로) + 노트북 제목 (editable, font-size: 15px, font-weight: 600)
